  ...
  <div class="top-bar">
	...
	<?php endif; ?>
     ...
     <?php if($bbcrm_option["bbcrm_fax_showhide"]): ?>
		<li id="contactusli"><a class="theme-color2-lt" href="tel:<?php echo $bbcrm_option['bbcrm_loginbar_fax']; ?>" ><i class="theme-color2-lt fa fa-fax"></i> <?php echo $bbcrm_option['bbcrm_loginbar_fax'];  ?> </a><span>&nbsp;&nbsp;|&nbsp;&nbsp;</span></li> 	
	<?php endif; ?>

     <?php if($bbcrm_option["bbcrm_email_showhide"]): ?>
		<li id="contactusli"><a class="theme-color2-lt" href="mailto:<?php echo $bbcrm_option['bbcrm_loginbar_email']; ?>" ><i class="theme-color2-lt fa fa-envelope-o"></i> <?php echo $bbcrm_option['bbcrm_loginbar_email'];  ?> </a><span>&nbsp;&nbsp;|&nbsp;&nbsp;</span></li> 	
	<?php endif; ?>
